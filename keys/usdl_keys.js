/***** Keys for obtaining data on US driver's licenses *****/
 ...
 */
export const StandardVersionNumber = "Standard Version Number";
 ...
 */
export const CustomerFamilyName = "Customer Family Name";
 ...
 */
export const CustomerFirstName = "Customer First Name";
 ...
 */
export const CustomerFullName = "Customer Name";
...
/**
 ...
 UNK    Unknown
 */
export const EyeColor = "Eye Color";
 ...
 */
export const AddressStreet = "Address - Street 1";
 ...
 */
export const AddressCity = "Address - City";
 ...
 */
export const AddressJurisdictionCode = "Address - Jurisdiction Code";
 ...
 */
export const AddressPostalCode = "Address - Postal Code";
...
/**
 ...
 Example: 5'9'': "69".
 */
export const HeightIn = "Height in";
 ...
 */
export const HeightCm = "Height cm";
 ...
 */
export const CustomerMiddleName = "Customer Middle Name";
...
/**
 ...
 UNK    Unknown
 */
export const HairColor = "Hair color";
...
/**
 ...
 - 9TH or IX (Ninth)
 */
export const NameSuffix = "Name Suffix";
 ...
 */
export const AKAFullName = "Alias / AKA Name";
 ...
 */
export const AKAFamilyName = "Alias / AKA Family Name";
 ...
 */
export const AKAGivenName = "Alias / AKA Given Name";
...
/**
 ...
 9TH        Ninth
 */
export const AKASuffixName = "Alias / AKA Suffix Name";
...
/**
 ...
 9: 146+ kg (321+ lbs)
 */
export const WeightRange = "Weight Range";
 ...
 */
export const WeightPounds = "Weight (pounds)";
 ...
 */
export const WeightKilograms = "Weight (kilograms)";
 ...
 */
export const CustomerIdNumber = "Customer ID Number";
 ...
 */
export const FamilyNameTruncation = "Family name truncation";
...
/**
 ...
 truncated (N), or – unknown whether truncated (U).
 */
export const FirstNameTruncation = "First name truncation";
...
/**
 ...
 truncated (N), or – unknown whether truncated (U).
 */
export const MiddleNameTruncation = "Middle name truncation";
 ...
 */
export const PlaceOfBirth = "Place of birth";
 ...
 */
export const AddressStreet2 = "Address - Street 2";
...
/**
 ...
 U      Unknown
 */
export const RaceEthnicity = "Race / ethnicity";
 ...
 */
export const NamePrefix = "Name Prefix";
 ...
 */
export const CountryIdentification = "Country Identification";
 ...
 */
export const ResidenceStreetAddress = "Driver Residence Street Address";
 ...
 */
export const ResidenceStreetAddress2 = "Driver Residence Street Address 2";
 ...
 */
export const ResidenceCity = "Driver Residence City";
 ...
 */
export const ResidenceJurisdictionCode = "Driver Residence Jurisdiction Code";
 ...
 */
export const ResidencePostalCode = "Driver Residence Postal Code";
 ...
 */
export const ResidenceFullAddress = "Driver Residence Full Address";
 ...
 */
export const Under18 = "Under 18 Until";
 ...
 */
export const Under19 = "Under 19 Until";
 ...
 */
export const Under21 = "Under 21 Until";
 ...
 */
export const SocialSecurityNumber = "Social Security Number";
 ...
 */
export const AKASocialSecurityNumber = "Alias / AKA Social Security Number";
 ...
 */
export const AKAMiddleName = "Alias / AKA Middle Name";
 ...
 */
export const AKAPrefixName = "Alias / AKA Prefix Name";
 ...
 */
export const OrganDonor = "Organ Donor Indicator";
 ...
 */
export const Veteran = "Veteran Indicator";
 ...
 */
export const AKADateOfBirth = "Alias / AKA Date of Birth";
 ...
 */
export const IssuerIdentificationNumber = "Issuer Identification Number";
 ...
 */
export const DocumentExpirationDate = "Document Expiration Date";
...
/**
 ...
 Version 00.
 */
export const JurisdictionVersionNumber = "Jurisdiction Version Number";
 ...
 */
export const JurisdictionVehicleClass = "Jurisdiction-specific vehicle class";
 ...
 */
export const JurisdictionRestrictionCodes = "Jurisdiction-specific restriction codes";
 ...
 */
export const JurisdictionEndorsementCodes = "Jurisdiction-specific endorsement codes";
 ...
 */
export const DocumentIssueDate = "Document Issue Date";
 ...
 */
export const FederalCommercialVehicleCodes = "Federal Commercial Vehicle Codes";
 ...
 */
export const IssuingJurisdiction = "Issuing jurisdiction";
 ...
 */
export const StandardVehicleClassification = "Standard vehicle classification";
...
*/
export const IssuingJurisdictionName = "Issuing jurisdiction name";
 ...
 */
export const StandardEndorsementCode = "Standard endorsement code";
...
/**
 ...
 W      Farm Waiver
 */
export const StandardRestrictionCode = "Standard restriction code";
 ...
 */
export const JurisdictionVehicleClassificationDescription = "Jurisdiction-specific vehicle classification description";
 ...
 */
export const JurisdictionEndorsmentCodeDescription = "Jurisdiction-specific endorsment code description";
 ...
 */
export const JurisdictionRestrictionCodeDescription = "Jurisdiction-spacific restriction code description";
 ...
 */
export const InventoryControlNumber = "Inventory control number";
 ...
 */
export const CardRevisionDate = "Card Revision Date";
 ...
 */
export const DocumentDiscriminator = "Document Discriminator";
 ...
 */
export const LimitedDurationDocument = "Limited Duration Document Indicator";
 ...
 */
export const AuditInformation = "Audit information";
 ...
 */
export const ComplianceType = "Compliance Type";
 ...
 */
export const IssueTimestamp = "Issue Timestamp";
 ...
 */
export const PermitExpirationDate = "Driver Permit Expiration Date";
...
/**
 ...
 Type of permit.
 */
export const PermitIdentifier = "Permit Identifier";
 ...
 */
export const PermitIssueDate = "Driver Permit Issue Date";
 ...
 */
export const NumberOfDuplicates = "Number of Duplicates";
...
/**
 ...
 no longer valid. (MMDDCCYY format)
 */
export const HAZMATExpirationDate = "HAZMAT Endorsement Expiration Date";
 ...
 */
export const MedicalIndicator = "Medical Indicator/Codes";
 ...
 */
export const NonResident = "Non-Resident Indicator";
 ...
 */
export const UniqueCustomerId = "Unique Customer Identifier";
 ...
 */
export const DataDiscriminator = "Data discriminator";
 ...
 */
export const DocumentExpirationMonth = "Document Expiration Month";
 ...
 */
export const DocumentNonexpiring = "Document Nonexpiring";
 ...
 */
export const SecurityVersion = "Security Version";
...
/**
 Raw pdf417 result
 */
export const Pdf417 = "kPPPdf417";

/**
 Raw code128 result
 */
export const Code128 = "kPPCode128";

/**
 Raw code39 result
 */
export const Code39 = "kPPCode39";
