...
public final class SingaporeChangiEmployeeIdRecognizerSerialization implements RecognizerSerialization {
    ...
    public Recognizer<?, ?> createRecognizer(ReadableMap jsonRecognizer) {
        ...
        if (jsonRecognizer.hasKey("extractCompanyName")) {
            recognizer.setExtractCompanyName(jsonRecognizer.getBoolean("extractCompanyName"));
        }
    ...
    public WritableMap serializeResult(Recognizer<?, ?> recognizer) {
        ...
        jsonResult.putString("companyName", result.getCompanyName());
