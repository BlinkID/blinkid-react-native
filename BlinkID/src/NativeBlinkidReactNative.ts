...
import type { ScanningMode } from './types';
//import type {BlinkIdSessionSettingsData, ClassFilterData } from './NativeBlinkIdReactNativeTypes';

export interface Spec extends TurboModule {
  performScan(blinkIdSdkSettings: string, blinkIdSessionSettings: string, classFilter?: string): Promise<string>
  performDirectApiScan(blinkIdSdkSettings: BlinkIdSdkSettingsData, blinkIdSessionSettings: BlinkIdSessionSettingsData, firstImage: string, secondImage?: string): Promise<BlinkIdScanningResult>
}

export default TurboModuleRegistry.getEnforcing<Spec>('BlinkidReactNative');

export interface BlinkIdSdkSettingsData {
      /**
...
export interface BlinkIdSessionSettingsData  {
      /**
       ...
       */ 
      scanningSettings: BlinkIdScanningSettingsData;
...
export interface BlinkIdScanningSettingsData {
    ...
    /**
      ...
      * See {@link DocumentRules} for more detailed information.
       */
      customDocumentRules?: DocumentRulesData[];
    ...
    /**
      ...
      * See {@link DocumentAnonymizationSettings} for more information.
       */
      customDocumentAnonymizationSettings?: DocumentAnonymizationSettingsData[];
    /**
    ...
    /**
      ...
      * By default all modes are enabled (set to `true`).
       */
      recognitionModeFilter: RecognitionModeFilterData;
...
export interface ClassFilterData {
   ...
   */
  includeDocuments?: DocumentFilterData[];
  /**
   ...
   * See {@link DocumentFilter} for setting the combinations.
   */
  excludeDocuments?: DocumentFilterData[];
...
export interface DocumentAnonymizationSettingsData {
       ...
       *
       */
      documentNumberAnonymizationSettings?: DocumentNumberAnonymizationSettingsData;
}
