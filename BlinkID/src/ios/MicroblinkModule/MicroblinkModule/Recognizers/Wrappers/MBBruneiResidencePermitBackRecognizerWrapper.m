...
@implementation MBBruneiResidencePermitBackRecognizerCreator
...
-(instancetype) init {
    self = [super init];
    if (self) {
        _jsonName = @"BruneiResidencePermitBackRecognizer";
    }
    return self;
}

-(MBRecognizer *) createRecognizer:(NSDictionary*) jsonRecognizer {
    MBBruneiResidencePermitBackRecognizer *recognizer = [[MBBruneiResidencePermitBackRecognizer alloc] init];
    {
...
@interface MBBruneiResidencePermitBackRecognizer (JsonSerialization)
@end

@implementation MBBruneiResidencePermitBackRecognizer (JsonSerialization)
