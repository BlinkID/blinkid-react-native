...
@implementation MBBruneiResidencePermitFrontRecognizerCreator
...
-(instancetype) init {
    self = [super init];
    if (self) {
        _jsonName = @"BruneiResidencePermitFrontRecognizer";
    }
    return self;
}

-(MBRecognizer *) createRecognizer:(NSDictionary*) jsonRecognizer {
    MBBruneiResidencePermitFrontRecognizer *recognizer = [[MBBruneiResidencePermitFrontRecognizer alloc] init];
    {
...
@interface MBBruneiResidencePermitFrontRecognizer (JsonSerialization)
@end

@implementation MBBruneiResidencePermitFrontRecognizer (JsonSerialization)
