...
@implementation MBMalaysiaMyKadFrontRecognizerCreator
...
-(instancetype) init {
    self = [super init];
    if (self) {
        _jsonName = @"MalaysiaMyKadFrontRecognizer";
    }
    return self;
}

-(MBRecognizer *) createRecognizer:(NSDictionary*) jsonRecognizer {
    MBMalaysiaMyKadFrontRecognizer *recognizer = [[MBMalaysiaMyKadFrontRecognizer alloc] init];
    {
...
@interface MBMalaysiaMyKadFrontRecognizer (JsonSerialization)
@end

@implementation MBMalaysiaMyKadFrontRecognizer (JsonSerialization)
