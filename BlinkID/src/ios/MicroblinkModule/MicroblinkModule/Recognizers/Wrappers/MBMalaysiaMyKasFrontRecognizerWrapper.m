...
@implementation MBMalaysiaMyKasFrontRecognizerCreator
...
-(instancetype) init {
    self = [super init];
    if (self) {
        _jsonName = @"MalaysiaMyKasFrontRecognizer";
    }
    return self;
}

-(MBRecognizer *) createRecognizer:(NSDictionary*) jsonRecognizer {
    MBMalaysiaMyKasFrontRecognizer *recognizer = [[MBMalaysiaMyKasFrontRecognizer alloc] init];
    {
...
@interface MBMalaysiaMyKasFrontRecognizer (JsonSerialization)
@end

@implementation MBMalaysiaMyKasFrontRecognizer (JsonSerialization)
