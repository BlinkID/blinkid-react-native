...
@implementation MBAustriaDlFrontRecognizerCreator
...
-(instancetype) init {
    self = [super init];
    if (self) {
        _jsonName = @"AustriaDlFrontRecognizer";
    }
    return self;
}

-(MBRecognizer *) createRecognizer:(NSDictionary*) jsonRecognizer {
    MBAustriaDlFrontRecognizer *recognizer = [[MBAustriaDlFrontRecognizer alloc] init];
    {
...
@interface MBAustriaDlFrontRecognizer (JsonSerialization)
@end

@implementation MBAustriaDlFrontRecognizer (JsonSerialization)
