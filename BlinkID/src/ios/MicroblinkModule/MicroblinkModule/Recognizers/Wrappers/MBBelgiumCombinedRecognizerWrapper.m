...
@implementation MBBelgiumCombinedRecognizerCreator
...
-(instancetype) init {
    self = [super init];
    if (self) {
        _jsonName = @"BelgiumCombinedRecognizer";
    }
    return self;
}

-(MBRecognizer *) createRecognizer:(NSDictionary*) jsonRecognizer {
    MBBelgiumCombinedRecognizer *recognizer = [[MBBelgiumCombinedRecognizer alloc] init];
    {
...
@interface MBBelgiumCombinedRecognizer (JsonSerialization)
@end

@implementation MBBelgiumCombinedRecognizer (JsonSerialization)
