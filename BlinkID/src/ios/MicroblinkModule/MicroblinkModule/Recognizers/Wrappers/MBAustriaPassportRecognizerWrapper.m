...
@implementation MBAustriaPassportRecognizerCreator
...
-(instancetype) init {
    self = [super init];
    if (self) {
        _jsonName = @"AustriaPassportRecognizer";
    }
    return self;
}

-(MBRecognizer *) createRecognizer:(NSDictionary*) jsonRecognizer {
    MBAustriaPassportRecognizer *recognizer = [[MBAustriaPassportRecognizer alloc] init];
    {
...
@interface MBAustriaPassportRecognizer (JsonSerialization)
@end

@implementation MBAustriaPassportRecognizer (JsonSerialization)
