...
@implementation MBJordanIdFrontRecognizerCreator
...
-(instancetype) init {
    self = [super init];
    if (self) {
        _jsonName = @"JordanIdFrontRecognizer";
    }
    return self;
}

-(MBRecognizer *) createRecognizer:(NSDictionary*) jsonRecognizer {
    MBJordanIdFrontRecognizer *recognizer = [[MBJordanIdFrontRecognizer alloc] init];
    {
...
@interface MBJordanIdFrontRecognizer (JsonSerialization)
@end

@implementation MBJordanIdFrontRecognizer (JsonSerialization)
