 ...
 */
export class GermanyIDBackSideRecognizerResult extends RecognizerResult {
 ...
 */
export class GermanyIDBackSideRecognizer extends Recognizer {
    constructor() {
        super('GermanyIDBackSideRecognizer');
