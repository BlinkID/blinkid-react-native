 ...
 */
export class GermanyIDFrontSideRecognizerResult extends RecognizerResult {
 ...
 */
export class GermanyIDFrontSideRecognizer extends Recognizer {
    constructor() {
        super('GermanyIDFrontSideRecognizer');
