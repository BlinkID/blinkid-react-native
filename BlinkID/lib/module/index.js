...
export { BlinkIdScanningSettings, BlinkIdSdkSettings, BlinkIdSessionSettings, CroppedImageSettings } from "./blinkIdSettings.js";
 ...
 * 
 */
export async function performScan(blinkIdSdkSettings, blinkIdSessionSettings, classFilter) {
 ...
 * This class contains the results of scanning a document, including the extracted data and images from the document.
 */
export async function performDirectApiScan(blinkIdSdkSettings, blinkIdSessionSettings, firstImage, secondImage) {
