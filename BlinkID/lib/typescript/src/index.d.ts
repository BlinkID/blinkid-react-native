...
export { BlinkIdScanningSettings, BlinkIdSdkSettings, BlinkIdSessionSettings, CroppedImageSettings, } from './blinkIdSettings';
 ...
 *
 */
export declare function performScan(blinkIdSdkSettings: BlinkIdSdkSettings, blinkIdSessionSettings: BlinkIdSessionSettings, classFilter?: ClassFilter): Promise<BlinkIdScanningResult>;
/**
 ...
 * This class contains the results of scanning a document, including the extracted data and images from the document.
 */
export declare function performDirectApiScan(blinkIdSdkSettings: BlinkIdSdkSettings, blinkIdSessionSettings: BlinkIdSessionSettings, firstImage: string, secondImage?: string): Promise<BlinkIdScanningResult>;
